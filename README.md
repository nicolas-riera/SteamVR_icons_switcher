...
SteamVR_icons_switcher is Python made tool that lets you switch icons from Valve's icons to custom icons, and vice-versa.

It includes :

- Custom HTC Vive Controller/Vive Wand icons:
    - from ![default_wand](assets/wands/default/driver%20folder/icons/controller_status_ready.b4bfb144.png) to ![custom_wand](/assets/wands/custom/driver%20folder/icons/controller_status_ready.b4bfb144.png)

- Custom Quest Pro Controller/Touch Pro icons:
    - from ![default_left_quest](/assets/Quest%20controllers/default/icons/rifts_left_controller_ready.b4bfb144.png) ![default_right_quest](/assets/Quest%20controllers/default/icons/rifts_right_controller_ready.b4bfb144.png)to ![custom_left_touch_pro](/assets/Quest%20controllers/custom/icons/rifts_left_controller_ready.b4bfb144.png)
